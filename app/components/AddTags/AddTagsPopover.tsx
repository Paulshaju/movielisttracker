...
export function AddTagsPopover({ imdbID, availableTags }: { imdbID: string; availableTags: string[] }) {
    const { tags } = useSnapshot(movieStore);
    const [tagInput, setTagInput] = useState('');

    const suggestions = Array.from(new Set([...PRESET_TAGS, ...tags.keys()])).filter((s) => !availableTags.includes(s));
