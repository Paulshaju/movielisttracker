...
import { getList, movieStore, removeFromWatched } from "@/store/store";
    ...
    if (watchedItems.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-12 text-center">
                <p className="text-sm font-medium text-foreground">Your watchedlist is empty</p>
    ...
    return (
        <div className="w-full space-y-2">
            <div className="flex items-baseline justify-between">
                ...
                <span className="text-sm text-muted-foreground">{watchedItems.length}</span>
            </div>
            <Separator />
